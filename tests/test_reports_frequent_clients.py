def test_frequent_clients(db, client, admin_token):
    ...
    client1 = Client(name="Juan", phone="111", is_active=True)
    ...
    response = client.get(
        f"/api/v1/reports/clients/frequent"
    ...
    assert data[0]["client"] == "Juan"
    assert data[0]["visitas"] == 2
